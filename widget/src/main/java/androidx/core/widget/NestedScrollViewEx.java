 ...
 */
public class NestedScrollViewEx extends FrameLayout implements NestedScrollingParent2,
     ...
     *
     * @see #setOnScrollChangeListener(NestedScrollViewEx.OnScrollChangeListener)
     */
    ...
    private NestedScrollViewEx.SavedState mSavedState;

    private static final NestedScrollViewEx.AccessibilityDelegate ACCESSIBILITY_DELEGATE = new NestedScrollViewEx.AccessibilityDelegate();
    ...
    private NestedScrollViewEx.OnScrollChangeListener mOnScrollChangeListener;
    ...
    protected float getBottomFadingEdgeStrength() {
        ...
        final NestedScrollViewEx.LayoutParams lp = (LayoutParams) child.getLayoutParams();
        final int length = getVerticalFadingEdgeLength();
     ...
     */
    public void setOnScrollChangeListener(@Nullable NestedScrollViewEx.OnScrollChangeListener l) {
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_DOWN: {
                ...
                // Workaround Patch [START]
                // https://stackoverflow.com/questions/31829976/onclick-method-not-working-properly-after-nestedscrollview-scrolled/32783524
                //mIsBeingDragged = !mScroller.isFinished();
                mIsBeingDragged = false;
                // Workaround Patch [END]
    ...
    int getScrollRange() {
        ...
        if (getChildCount() > 0) {
            View child = getChildAt(0);
            NestedScrollViewEx.LayoutParams lp = (LayoutParams) child.getLayoutParams();
            int childSize = child.getHeight() + lp.topMargin + lp.bottomMargin;
            int parentSpace = getHeight() - getPaddingTop() - getPaddingBottom();
    ...
    public boolean pageScroll(int direction) {
        ...
        if (down) {
            ...
            if (count > 0) {
                ...
                NestedScrollViewEx.LayoutParams lp = (LayoutParams) view.getLayoutParams();
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        if (!(state instanceof NestedScrollViewEx.SavedState)) {
            super.onRestoreInstanceState(state);
            return;
        }

        NestedScrollViewEx.SavedState ss = (NestedScrollViewEx.SavedState) state;
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        NestedScrollViewEx.SavedState ss = new NestedScrollViewEx.SavedState(superState);
    ...
    static class SavedState extends BaseSavedState {
        ...
        public static final Parcelable.Creator<NestedScrollViewEx.SavedState> CREATOR =
                new Parcelable.Creator<NestedScrollViewEx.SavedState>() {
                    @Override
                    public NestedScrollViewEx.SavedState createFromParcel(Parcel in) {
                        return new NestedScrollViewEx.SavedState(in);
                    }

                    @Override
                    public NestedScrollViewEx.SavedState[] newArray(int size) {
                        return new NestedScrollViewEx.SavedState[size];
                    }
                };
    }
