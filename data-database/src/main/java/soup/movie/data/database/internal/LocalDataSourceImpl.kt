 ...
 */
package soup.movie.data.database.internal

import kotlinx.coroutines.flow.Flow
import kotlinx.coroutines.flow.catch
import kotlinx.coroutines.flow.map
import soup.movie.data.database.LocalDataSource
import soup.movie.data.database.internal.dao.FavoriteMovieDao
import soup.movie.data.database.internal.dao.MovieCacheDao
import soup.movie.data.database.internal.dao.OpenDateAlarmDao
import soup.movie.data.database.internal.entity.MovieListEntity
import soup.movie.data.database.internal.entity.MovieListEntity.Companion.TYPE_NOW
import soup.movie.data.database.internal.entity.MovieListEntity.Companion.TYPE_PLAN
import soup.movie.data.database.internal.mapper.toEntity
import soup.movie.data.database.internal.mapper.toFavoriteMovieEntity
import soup.movie.data.database.internal.mapper.toMovie
import soup.movie.data.database.internal.mapper.toMovieEntity
import soup.movie.data.database.internal.mapper.toOpenDateAlarm
import soup.movie.data.database.internal.mapper.toOpenDateAlarmEntity
